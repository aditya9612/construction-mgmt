...
class Contractor(Base):
    ...
    total_work_assigned = Column(Float, default=0)
    payment_given = Column(Float, default=0)
    bank_details = Column(String(255), nullable=False)

    projects = relationship("ContractorProject", back_populates="contractor", cascade="all, delete-orphan")
