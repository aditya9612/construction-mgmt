...
Revision ID: 1023d939eed3
Revises: 
Create Date: 2026-04-22 16:34:56.333173
"""
...
def upgrade():
    ...
    sa.Column('email', sa.VARCHAR(length=255, collation='utf8mb4_0900_ai_ci'), nullable=False),
    ...
    op.create_index(op.f('ix_daily_site_reports_business_id'), 'daily_site_reports', ['business_id'], unique=True)
    ...
    op.create_index(op.f('ix_issues_business_id'), 'issues', ['business_id'], unique=True)
    ...
    sa.Column('rate_type', sa.Enum('FIXED', 'PER_UNIT', 'PER_KG', 'PER_TON', 'PER_BAG', name='rate_type_enum', native_enum=False, create_constraint=True), nullable=False),
    sa.Column('purchase_rate', sa.DECIMAL(precision=18, scale=2), nullable=False),
    sa.Column('quantity_purchased', sa.DECIMAL(precision=18, scale=3), server_default=sa.text('0.000'), nullable=False),
    sa.Column('quantity_used', sa.DECIMAL(precision=18, scale=3), server_default=sa.text('0.000'), nullable=False),
    sa.Column('remaining_stock', sa.DECIMAL(precision=18, scale=3), server_default=sa.text('0.000'), nullable=False),
    sa.Column('payment_given', sa.DECIMAL(precision=18, scale=2), server_default=sa.text('0.00'), nullable=False),
    ...
    sa.Column('advance_amount', sa.DECIMAL(precision=18, scale=2), server_default=sa.text('0.00'), nullable=False),
    sa.Column('minimum_stock_level', sa.DECIMAL(precision=18, scale=3), server_default=sa.text('0.000'), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.CheckConstraint('minimum_stock_level >= 0', name='check_min_stock_not_negative'),
    sa.CheckConstraint('remaining_stock >= 0', name='check_stock_not_negative'),
    sa.ForeignKeyConstraint(['project_id'], ['projects.id'], ),
    sa.ForeignKeyConstraint(['supplier_id'], ['suppliers.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('project_id', 'material_name', 'supplier_id', name='unique_material_per_project_supplier')
    )
    ...
    sa.Column('check_in_latitude', sa.DECIMAL(precision=9, scale=6), nullable=True),
    sa.Column('check_in_longitude', sa.DECIMAL(precision=9, scale=6), nullable=True),
    sa.Column('check_out_latitude', sa.DECIMAL(precision=9, scale=6), nullable=True),
    sa.Column('check_out_longitude', sa.DECIMAL(precision=9, scale=6), nullable=True),
    ...
    sa.Column('usage_date', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['material_id'], ['materials.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['project_id'], ['projects.id'], ),
...
def downgrade():
    ...
    op.drop_index(op.f('ix_daily_site_reports_business_id'), table_name='daily_site_reports')
    ...
    op.drop_index(op.f('ix_cad_conversions_id'), table_name='cad_conversions')
