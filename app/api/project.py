            ...
            "tasks": [
                {
                    "name": t.title,
                    "assignee": (
                        ", ".join([a.user.full_name for a in t.assignments if a.user and a.user.full_name]) if t.assignments else "Unassigned"
                    ),
...
@tasks_router.post(
    "/{project_id}/tasks", response_model=s.TaskOut
)
async def create_task(
    project_id: int,
...
@tasks_router.get(
    "/{project_id}/tasks/{task_id}", response_model=s.TaskOut
)
async def get_task(
    project_id: int,
    task_id: int,
