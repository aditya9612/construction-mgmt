...
from sqlalchemy import DateTime, ForeignKey, Integer, String, Text, func, Boolean, Enum as SAEnum
...
class Document(Base, TimestampMixin):
    ...
    document_type: Mapped[Optional[str]] = mapped_column(String(100), nullable=True) # Drawing, Invoice, etc.
    file_url: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    file_size: Mapped[Optional[int]] = mapped_column(Integer, nullable=True) # in bytes
    version: Mapped[Optional[str]] = mapped_column(String(50), nullable=True, default="v1.0")
