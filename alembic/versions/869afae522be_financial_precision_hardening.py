...
def upgrade():
    ...
    # Optional Dummy Quotation financial charges
    op.add_column(
        "dummy_quotations",
        sa.Column("transport", sa.DECIMAL(18, 2), nullable=True),
    )

    op.add_column(
        "dummy_quotations",
        sa.Column("other", sa.DECIMAL(18, 2), nullable=True),
    )


def downgrade():

    # Remove Optional Dummy Quotation financial charges
    op.drop_column("dummy_quotations", "other")
    op.drop_column("dummy_quotations", "transport")
